...
from openalea.core import IFileStr, IInt
...
leaves = CNF(uid="1c21fd6a4f2011e6b469d4bed973e64a",
             name='leaves',
             description='Fit leaf data into a geometrical model',
             category='geometry',
             doc='',
             inputs=[
                 {'desc': 'Midrib curves of leaves', 'interface': IFileStr,
                  'name': 'leaf_database', 'value': None},
                 {'desc': 'Number of leaf sectors', 'interface': IInt,
                  'name': 'nb_sectors', 'value': 7}],
             ...
             elt_data={2: {'block': False,
                       ...
                       '__out__': {'block': False,
                                   ...
                                   'user_application': None,
                                   'user_color': None}},
             elt_value={2: [], 3: [], 4: [(1, 'None'), (2, 'False')],
                        '__in__': [], '__out__': []},
             elt_ad_hoc={2: {'useUserColor': False,
                             'position': [-166.74502103784138,
                                          -109.95444946135717],
                             'userColor': None},
                         3: {'useUserColor': False,
                             'position': [-92.4227816421706,
                                          -43.20169118234779],
                             'userColor': None},
                         4: {'useUserColor': False,
                             'position': [-109.65382073133082,
                                          41.21903888954781],
                             'userColor': None},
                         '__in__': {'useUserColor': False,
                                    'position': [-74.9879298828165,
                                                 -169.97674397328998],
                                    'userColor': None},
                         '__out__': {'useUserColor': False,
                                     'position': [-96.45061824038132,
                                                  72.99512198066596],
                                     'userColor': None}},
             lazy=True,
