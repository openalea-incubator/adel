...
#
#The second list should provide two Rfunctions of axe number, leaf position and leaf position counted from top (plus leaf stage for Lindex, defined as curent length/final length). Returned values should be :
#
# for azim : the azimuth (deg) of the leaf compared to the previous one
# for Lindex : the index of the collection to use for leaf shape
#
