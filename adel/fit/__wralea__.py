...
thermal_time_thermal_time = Factory(name='thermal_time',
                ...
                inputs=[{'interface': None, 'name': 'requested_dates', 'value': None, 'desc': 'The dates for which the thermal time increment has to be calculated. These dates must belong to input_data, and be >= to emergence_date.'}, {'interface': IDict, 'name': 'emergence_date', 'value': {'hour': 0, 'month': 5, 'second': 0, 'year': 1998, 'day': 31, 'minute': 0}, 'desc': 'The emergence date. The interval [emergence date, emergence date + 1 year[ must be included in input_data. emergence_datetime must be <= than requested_dates'}, {'interface': None, 'name': 'input_data', 'value': None, 'desc': 'The input data. Expect a pandas.DataFrame object. The dataframe index must contain dates.'}, {'interface': IEnumStr(enum=['daily', 'hourly']), 'name': 'data_type', 'value': None, 'desc': "The type of the input data. Can be either 'daily' or 'hourly'."}, {'interface': IEnumStr(enum=['dsT', 'dsTc']), 'name': 'thermal_time_increment_method', 'value': None, 'desc': "The method used for thermal time increment calculation. Can be either 'dsT' or 'dsTc' (compensated)."}, {'interface': IFloat, 'name': 'latitude', 'value': 55, 'desc': "The latitude where the data have been measured. Used to convert 'daily' data to 'hourly' data."}],
