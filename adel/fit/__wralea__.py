...
fit_adel_input_data_fit_adel_input_data = Factory(name='fit_adel_input_data',
                ...
                inputs=({'interface': None, 'name': 'user_parameters', 'desc': 'the parameters set by the user. Can be either a path or a table.'},
                        {'interface': None, 'name': 'user_dims', 'desc': 'a table describing the organ dimensions set by the user.'},
