...
def fit_adel_input_data_second(first_axis_table_dataframe, user_dim_table_dataframe, user_parameter_table_dataframe, 
    ...
    # TODO: 
    # - table supplementaire : TT, NbreAxes actifs, Nbre axes theorique, Nbre axes simule, (cf. second_axis_table_dataframe)
    # - table supplementaire : Nbre axes theorique, Nbre axes simule pour chaque cohorte et pour l'ensemble des cohortes
    # --> a voir: boite supplementaire analyse csv
...
def fit_user_parameters_second(user_parameter_table_dataframe, user_dim_table_dataframe, GL_number, leaf_number_delay_MS_cohort_dict=leaf_number_delay_MS_cohort_dict):
    ...
    :Parameters:
        - `user_parameter_table_dataframe` : the user observations table, with the following headers: 
            ...
            * d: ??? 
                This parameter don't have to be specified.
                d = n2
            * RMSE_gl: the RMSE of 'a' estimation.
                This parameter don't have to be specified.
    ...
    decimal_elongated_internode_number = np.polyfit(first_axis_L_internode_series, first_axis_index_phytomer_series, 2)[2]
    ...
    if copy_dataframe['TT_col_break'][0] == 0.0: # linear mode
        ...
        copy_dataframe['n0'][n0_smaller_than_HS_break_indexes] = copy_dataframe['TT_col_0'][n0_smaller_than_HS_break_indexes] + copy_dataframe['n0'][n0_smaller_than_HS_break_indexes] / copy_dataframe['a_cohort'][n0_smaller_than_HS_break_indexes]
        copy_dataframe['n0'][n0_greater_than_HS_break_indexes] = (copy_dataframe['n0'][n0_greater_than_HS_break_indexes] - HS_break[n0_greater_than_HS_break_indexes]) / a2[n0_greater_than_HS_break_indexes] + copy_dataframe['TT_col_break'][n0_greater_than_HS_break_indexes]    
    
    # Fit copy_dataframe['t2'].
    copy_dataframe['t2'] = copy_dataframe['TT_col_nff']
    
    # Fit copy_dataframe['a'], copy_dataframe['c'] and copy_dataframe['d']
    # For the main stem most frequent axis
