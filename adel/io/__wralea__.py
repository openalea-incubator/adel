...
# This file has been generated at Wed Feb 20 16:00:23 2013
...
__all__ = ['io_canL2canS', 'io_pandasDataframe2csv', 'io_select_data_file', 'io_dataframe', 'io_readRData', 'data2PandasDataframe', 'io_mtg2lpy', 'io_to_canestra', 'PairAsDict_PairAsDict', 'io_lpy2mtg', 'io_duplicate', 'io_mtg_factory', 'io_csvAsDict', 'io_saveRData', 'GetAdelString_GetAdelString', 'io_load_leaf_data', 'io_csv2pandasDataframe', 'io_dataframeAsdict', 'io_RlistAsDict', 'io_thermal_time', 'io_apply_property', 'image_save_image', 'pandasDataframe2data', 'io_to_plantgl']
...
data2PandasDataframe = CompositeNodeFactory(name='data2PandasDataframe',
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  19: {'useUserColor': False, 'position': [509.64542300600647, -31.791839043245815], 'userColor': None},
   20: {'useUserColor': False, 'position': [491.8627065927451, 21.13472567390702], 'userColor': None},
   '__in__': {'position': [521.8488883496688, -88.5714957876693], 'userColor': None, 'useUserColor': False},
   '__out__': {'position': [550.9668572660541, 78.82221022550736], 'userColor': None, 'useUserColor': False}},
                             lazy=True,
...
pandasDataframe2data = CompositeNodeFactory(name='pandasDataframe2data',
   ...
   14: ('alinea.adel.io', 'pandasDataframe2csv')},
                             elt_connections={  34301928: (8, 0, 14, 1),
   34301952: ('__in__', 1, 8, 0),
   34301976: ('__in__', 2, 8, 1),
   34302000: ('__in__', 3, 8, 2),
   34302024: (14, 0, '__out__', 0),
   34302048: ('__in__', 0, 14, 0)},
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3db49d0> : "pandasDataframe2csv"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set(),
                'posx': 344.14033370419804,
                'posy': -144.7760830037442,
                'priority': 0,
                'use_user_color': False,
                'user_application': None,
                'user_color': None},
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': 369.1535479205524,
                 'posy': 135.44012208426494,
                 'priority': 0,
                 'use_user_color': False,
                 'user_application': None,
                 'user_color': None}},
                             elt_value={  8: [],
   14: [(2, 'None'), (3, 'True'), (4, 'None')],
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  8: {'useUserColor': False, 'position': [371.164776354299, -25.54821877276729], 'userColor': None},
   14: {'useUserColor': False, 'position': [305.4928529228377, 48.03346744069775], 'userColor': None},
   '__in__': {'useUserColor': False, 'position': [344.14033370419804, -144.7760830037442], 'userColor': None},
   '__out__': {'useUserColor': False, 'position': [369.1535479205524, 135.44012208426494], 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
