...
# Carrefull ! declaring 'io' in nodemodule confuse node.instantiate with a previously imported io (local io will not be imported at the right time, which lead to strange import errors in visualea). Declare full name 'alinea.adel.io.io'
...
io_select_adel_geometric_data = Factory(name='select_adel_geometric_data',
                ...
                widgetmodule='openalea.file.files',
