...
plot_HS_GL_SSI_T_plot_HS_GL_SSI_T = Factory(name='plot_HS_GL_SSI_T',
                ...
                inputs=({'interface': None, 'name': 'HS_GL_SSI_T', 'desc': 'the HS_GL_SSI_T dataframe'},
                        {'interface': ISequence, 'name': 'id_phen_to_plot', 'value': None, 'desc': 'the list of id_phen to plot. If None (the default) or empty, then plot all the id_phen.'},
                        {'interface': ISequence, 'name': 'dynamics_to_plot', 'value': None, 'desc': "the list of dynamics to plot. The available dynamic are: 'HS', 'GL' and 'SSI'. If None (the default) or empty, then plot all the dynamics."},
...
plot_dimT_plot_dimT = Factory(name='plot_dimT',
                ...
                inputs=({'interface': None, 'name': 'dimT', 'desc': 'the dimT dataframe'},
                        ...
                        {'interface': ISequence, 'name': 'dimensions_to_plot', 'value': None, 'desc': 'the list of dimensions to plot. If None (the default) or empty, then plot all the dimensions.'},
                        {'interface': ISequence, 'name': 'id_dim_to_plot', 'value': None, 'desc': 'the list of id_dim to plot. If None (the default) or empty, then plot all the id_dim.'},
                        {'interface': ISequence, 'name': 'id_cohort_to_plot', 'value': None, 'desc': 'the list of id_cohort to plot. If None (the default) or empty, then plot all the id_cohort.'},
                        {'interface': IBool, 'name': 'plot_non_regressive_tillers', 'value': True, 'desc': 'whether to plot the non regressive tillers or not. Non regressive tillers have id_dim ending by 1. Default is to plot the non regressive tillers.'},
                        {'interface': IBool, 'name': 'plot_regressive_tillers', 'value': True, 'desc': 'whether to plot the regressive tillers or not. Regressive tillers have id_dim ending by 0. Default is to plot the regressive tillers.'},
