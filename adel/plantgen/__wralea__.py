...
plot_HS_GL_SSI_T_plot_HS_GL_SSI_T = Factory(name='plot_HS_GL_SSI_T',
                ...
                inputs=({'interface': None, 'name': 'HS_GL_SSI_T', 'desc': 'the HS_GL_SSI_T dataframe'},
                        ...
                        {'interface': ISequence, 'name': 'dynamics_to_plot', 'value': None, 'desc': "the list of dynamics to plot. The available dynamic are: 'HS', 'GL' and 'SSI'. If None (the default), then plot all the dynamics."},
