def AdelRunOptions(leafDuration, fracLeaf, stemDuration, dHS_col, senescence_leaf_shrink, epsillon,HSstart_inclination_tiller, rate_inclination_tiller, drop_empty):
