...
simulation_RunAdel = Factory(name='RunAdel',
                ...
                nodemodule='alinea.adel.simulation.simulation',
                nodeclass='RunAdel',
                inputs=[{'interface': ISequence, 'name': 'dates', 'value': 1000, 'desc': ''}, {'interface': None, 'name': 'Parameter Rlist', 'desc': ''}, {'interface': IDict, 'name': 'Global parameters', 'value': {'leafDuration': 2.0,'fracLeaf': 0.2, 'stemDuration': 1.7, 'dHS_col':0.2, 'epsillon': 9.9999999999999995e-07, 'senescence_leaf_shrink': 0.5, 'HSstart_inclination_tiller': 1, 'rate_inclination_tiller': 30}, 'desc': ''}],
