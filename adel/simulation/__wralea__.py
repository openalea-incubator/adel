...
AdelRunOptions_AdelRunOptions = Factory(name='AdelRunOptions',
                ...
                inputs=[{'interface': IFloat, 'name': 'startLeaf', 'value': 2.0, 'desc': ''}, 
                        {'interface': IFloat, 'name': 'endLeaf', 'value': 0.2, 'desc': ''}, 
                        {'interface': IFloat, 'name': 'stemLeaf', 'value': 1.7, 'desc': ''},
                        {'interface': IFloat, 'name': 'senescence_leaf_shrink', 'value': 0.2, 'desc': ''}, 
                        {'interface': IFloat, 'name': 'epsillon', 'value': 0.0, 'desc': ''}, 
                        {'interface': IFloat, 'name': 'HSstart_inclination_tiller', 'value': 0.5, 'desc': ''}, 
                        {'interface': IFloat, 'name': 'rate_inclination_tiller', 'value': 0.0, 'desc': ''}],
