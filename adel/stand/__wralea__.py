...
stand_agronomicplot = Factory(name='agronomic plot',
                ...
                inputs=[{'interface': IFloat, 'name': 'Plot length (m)', 'value': 1, 'desc': 'plot dimension along row direction'}, 
                        ...
                        {'interface': IInt, 'name': 'conversion factor from meter to scene unit', 'value': 100, 'desc': ''},
                        {'interface': IBool, 'name': 'center scene', 'value': True, 'desc': 'center the scene on origin'}],
