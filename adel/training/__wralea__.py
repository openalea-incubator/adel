...
__all__ = ['sleep_sleep', 'sleep_leaf_sectors_by_number',
           'sleep_compute_distance', 'sleep_get_distances', '_150448656',
           'sleep_leaf_sectors']

sleep_sleep = Fa(uid="175664e54f2011e6b469d4bed973e64a",
                 name='sleep',
                 ...
                 nodeclass='sleep',
                 inputs=[{'interface': None, 'name': 'obj', 'value': None,
                          'desc': 'Python object'},
                         {'interface': IFloat, 'name': 'seconds', 'value': 0.0,
                          'desc': 'delay execution for a given number of seconds'}],
                 outputs=[{'interface': None, 'name': 'obj', 'desc': ''}],
                 widgetmodule=None,
                 widgetclass=None,
                 )

sleep_leaf_sectors_by_number = Fa(uid="175664e64f2011e6b469d4bed973e64a",
                                  name='filter leaf sectors by number',
                                  authors=' (wralea authors)',
                                  description='',
                                  category='time',
                                  nodemodule='alinea.adel.training.sleep',
                                  nodeclass='leaf_sectors_by_number',
                                  inputs=[{'interface': None, 'name': 'g',
                                           'desc': 'MTG'}, {'interface': IInt,
                                                            'name': 'target leaf number',
                                                            'value': 1,
                                                            'desc': 'Target leaf number, counted from the top'},
                                          {'interface': IInt,
                                           'name': 'infectious leaf number',
                                           'value': 4,
                                           'desc': 'Infectious leaf number considered, counted from the top'}],
                                  outputs=[{'name': 'g', 'desc': 'MTG'},
                                           {'interface': ISequence,
                                            'name': 'target sectors',
                                            'desc': 'target sectors that can be infected'},
                                           {'interface': ISequence,
                                            'name': 'source sectors',
                                            'desc': 'source sectors of the infection'}],
                                  widgetmodule=None,
                                  widgetclass=None,
                                  )

sleep_compute_distance = Fa(uid="175664e74f2011e6b469d4bed973e64a",
...
sleep_get_distances = Fa(uid="175664e84f2011e6b469d4bed973e64a",
                         name='get distances',
                         authors=' (wralea authors)',
                         ...
                         inputs=[
                             {'interface': None, 'name': 'obj', 'value': None,
                              'desc': 'mtg'},
                             {'interface': IFileStr, 'name': 'filename',
                              'value': None,
                              'desc': 'labels of the results computed by distance function'}],
                         outputs=[{'interface': IFileStr, 'name': 'filename',
                                   'desc': ''},
                                  {'interface': ISequence, 'name': 'leaves',
                                   'desc': ''},
                                  {'interface': None, 'name': 'sectors',
                                   'desc': ''},
                                  {'interface': None, 'name': 'age',
                                   'desc': ''},
                                  {'interface': None, 'name': 'distance',
                                   'desc': ''}],
                         widgetmodule=None,
                         widgetclass=None,
                         )

_150448656 = CNF(uid="175664e44f2011e6b469d4bed973e64a",
                 name='TD simple wheat',
                 description='',
                 category='Unclassified',
                 doc='',
                 inputs=[],
                 ...
                 elt_factory={2: ('openalea.flow control', 'iter'),
                              ...
                              24: (
                              'alinea.adel.parameterisation', 'MonoAxeWheat'),
                 ...
                 elt_data={2: {'block': False,
                           ...
                           21: {'block': False,
                                ...
                                'user_color': None},
                           22: {
                               'factory': '<openalea.core.node.NodeFactory object at 0x06AA6A10> : "annotation"',
                               'id': 22,
                 ...
                 elt_value={2: [],
                            ...
                            29: [(0, '1')],
                            30: [(0,
                                  "'C:/Users/fourniec/Desktop/distance.csv'")],
                            31: [],
                            32: [],
                            ...
                            '__out__': []},
                 elt_ad_hoc={
                     2: {'position': [-647.33725166078978, 91.445517705871538],
                         'userColor': None, 'useUserColor': False},
                     3: {'position': [-264.61667837411221, 18.235695264082899],
                         'userColor': None, 'useUserColor': False},
                     4: {'position': [-133.81906942530145, -84.973067510462613],
                         'userColor': None, 'useUserColor': False},
                     5: {'position': [-877.3322917735004, 63.031161668397033],
                         'userColor': None, 'useUserColor': False},
                     6: {'position': [-426.3662957601191, -177.562239130855],
                         'useUserColor': False,
                         'userColor': None},
                     7: {'position': [-280.33937538020911, -141.3137814336595],
                         'userColor': None, 'useUserColor': False},
                     8: {'position': [-412.69185305852437, 375.68415971360236],
                         'userColor': None, 'useUserColor': False},
                     9: {'position': [-660.53125394421431, 423.90630558728861],
                         'userColor': None, 'useUserColor': False},
                     10: {'position': [-432.58118028091036, 93.138373830018381],
                          'userColor': None, 'useUserColor': False},
                     11: {
                         'position': [-83.684903971131789, -84.636056713762557],
                         'userColor': None, 'useUserColor': False},
                     12: {
                         'position': [-174.30275989038273, -29.375008838525986],
                         'userColor': None, 'useUserColor': False},
                     13: {'position': [-404.84173628838943, 487.82868500124482],
                          'userColor': None, 'useUserColor': False},
                     14: {'position': [-646.95209757822283, 144.5570620962329],
                          'userColor': None, 'useUserColor': False},
                     15: {
                         'position': [-635.47791093364845, 0.63906075107892946],
                         'userColor': None, 'useUserColor': False},
                     16: {'position': [-573.56299708990855, 340.93597326920951],
                          'userColor': None, 'useUserColor': False},
                     17: {'position': [-702.12611755575961, 231.73008536616928],
                          'userColor': None, 'useUserColor': False},
                     18: {'position': [-493.3760249421872, 221.64977132794871],
                          'userColor': None, 'useUserColor': False},
                     19: {
                         'position': [-143.34879438495653, -131.56298631052479],
                         'userColor': None, 'useUserColor': False},
                     20: {'position': [-617.98247651656789, 377.83809240601823],
                          'userColor': None, 'useUserColor': False},
                     21: {'position': [-681.84735400495879, 281.7039282854048],
                          'userColor': None, 'useUserColor': False},
                     22: {'visualStyle': 0, 'position': [-829.41464120135356,
                                                         -39.437297313712264],
                          'color': None, 'text': u'Number of sectors / leaf',
                          'textColor': None, 'rectP2': (-1, -1)},
                     23: {'position': [-784.45869367292312, 1.2037922647801071],
                          'userColor': None, 'useUserColor': False},
                     24: {'position': [-941.9363918301533, 13.527135298635303],
                          'userColor': None, 'useUserColor': False},
                     25: {'position': [-548.51116369127533, 96.623694274316705],
                          'userColor': None, 'useUserColor': False},
                     26: {'position': [-605.62465564345712, 469.56427165392739],
                          'userColor': None, 'useUserColor': False},
                     27: {'position': [-874.7587733467376, 120.96785766271395],
                          'userColor': None, 'useUserColor': False},
                     28: {'position': [-656.08116000608527, 53.621357307731415],
                          'userColor': None, 'useUserColor': False},
                     29: {
                         'position': [-285.09477082109731, -14.791873182544558],
                         'userColor': None, 'useUserColor': False},
                     30: {'position': [-365.59115243771453, 331.9477948514218],
                          'userColor': None, 'useUserColor': False},
                     31: {'position': [-423.90630558728861, 435.12075811605285],
                          'userColor': None, 'useUserColor': False},
                     32: {
                         'position': [-35.432269627069978, -144.73844039712225],
                         'userColor': None, 'useUserColor': False},
                     33: {
                         'position': [-38.467270414011807, -179.83448918550513],
                         'userColor': None, 'useUserColor': False},
                     34: {
                         'position': [-144.25226405254418, -173.10271686305302],
                         'userColor': None, 'useUserColor': False},
                     35: {'position': [-277.9260287412352, 54.815860339966768],
                          'userColor': None, 'useUserColor': False},
                     36: {'position': [-328.58345909279251, 502.40747328863841],
                          'userColor': None, 'useUserColor': False},
...
sleep_leaf_sectors = Fa(uid="175664e94f2011e6b469d4bed973e64a",
                        name='filter leaf sectors',
                        authors=' (wralea authors)',
                        description='',
                        category='time',
                        nodemodule='alinea.adel.training.sleep',
                        nodeclass='leaf_sectors',
                        inputs=[{'interface': None, 'name': 'g', 'desc': 'MTG'},
                                {'interface': IInt, 'name': 'leaf number',
                                 'value': 0,
                                 'desc': '0: all, n: leaf numbre from the top'},
                                {'interface': IInt, 'name': 'latency',
                                 'value': 350,
                                 'desc': 'desease latency in degree.day'}],
                        outputs=[{'name': 'g', 'desc': 'MTG'},
                                 {'interface': ISequence,
                                  'name': 'target sectors',
                                  'desc': 'target sectors that can be infected'},
