...
typedef struct  {
                ...
                Mcomplex *base;          /* base is base of alloc'd mem */
                Mcomplex **me;
                } ZMAT;
...
extern Mcomplex	z_finput(FILE *fp);
...
extern ZMAT	*zsm_mlt(Mcomplex scalar,ZMAT *matrix,ZMAT *out);
...
extern ZMAT	*mz_mltadd(ZMAT *A1,ZMAT *A2,Mcomplex s,ZMAT *out);
extern ZVEC	*zmv_mltadd(ZVEC *v1,ZVEC *v2,ZMAT *A,Mcomplex alpha,ZVEC *out);
extern ZVEC	*zvm_mltadd(ZVEC *v1,ZVEC *v2,ZMAT *A,Mcomplex alpha,ZVEC *out);
...
extern Mcomplex	_zin_prod(ZVEC *x,ZVEC *y,u_int i0,u_int flag);
extern ZVEC	*zv_resize(ZVEC *x,int new_dim);
extern ZVEC	*zv_mlt(Mcomplex scalar,ZVEC *vector,ZVEC *out);
extern ZVEC	*zv_add(ZVEC *vec1,ZVEC *vec2,ZVEC *out);
extern ZVEC	*zv_mltadd(ZVEC *v1,ZVEC *v2,Mcomplex scale,ZVEC *out);
extern ZVEC	*zv_sub(ZVEC *vec1,ZVEC *vec2,ZVEC *out);
#ifdef PROTOTYPES_IN_STRUCT
extern ZVEC	*zv_map(Mcomplex (*f)(),ZVEC *x,ZVEC *out);
extern ZVEC	*_zv_map(Mcomplex (*f)(),void *params,ZVEC *x,ZVEC *out);
#else
extern ZVEC	*zv_map(Mcomplex (*f)(Mcomplex),ZVEC *x,ZVEC *out);
extern ZVEC	*_zv_map(Mcomplex (*f)(void *,Mcomplex),void *params,ZVEC *x,ZVEC *out);
#endif
extern ZVEC	*zv_lincomb(int n,ZVEC *v[],Mcomplex a[],ZVEC *out);
extern ZVEC	*zv_linlist(ZVEC *out,ZVEC *v1,Mcomplex a1,...);
...
extern void	__zconj__(Mcomplex zp[], int len);
extern Mcomplex	__zip__(Mcomplex zp1[],Mcomplex zp2[],int len,int flag);
extern void	__zmltadd__(Mcomplex zp1[],Mcomplex zp2[],
			    Mcomplex s,int len,int flag);
extern void	__zmlt__(Mcomplex zp[],Mcomplex s,Mcomplex out[],int len);
extern void	__zadd__(Mcomplex zp1[],Mcomplex zp2[],Mcomplex out[],int len);
extern void	__zsub__(Mcomplex zp1[],Mcomplex zp2[],Mcomplex out[],int len);
extern void	__zzero__(Mcomplex zp[],int len);
extern void	z_foutput(FILE *fp,Mcomplex z);
...
Mcomplex	zmake(double real, double imag);
double	zabs(Mcomplex z);
Mcomplex zadd(Mcomplex z1,Mcomplex z2);
Mcomplex zsub(Mcomplex z1,Mcomplex z2);
Mcomplex	zmlt(Mcomplex z1,Mcomplex z2);
Mcomplex	zinv(Mcomplex z);
Mcomplex	zdiv(Mcomplex z1,Mcomplex z2);
Mcomplex	zsqrt(Mcomplex z);
Mcomplex	zexp(Mcomplex z);
Mcomplex	zlog(Mcomplex z);
Mcomplex	zconj(Mcomplex z);
Mcomplex	zneg(Mcomplex z);
#else
