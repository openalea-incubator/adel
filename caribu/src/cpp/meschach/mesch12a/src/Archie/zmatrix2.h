...
extern ZVEC	*zhhvec(ZVEC *,int,Real *,ZVEC *,Mcomplex *);
...
extern void	zgivens(Mcomplex, Mcomplex, Real *, Mcomplex *);
extern ZMAT	*zrot_rows(ZMAT *A, int i, int k, double c, Mcomplex s,
			   ZMAT *out);
extern ZMAT	*zrot_cols(ZMAT *A, int i, int k, double c, Mcomplex s,
			   ZMAT *out);
extern ZVEC	*rot_zvec(ZVEC *x, int i, int k, double c, Mcomplex s,
			  ZVEC *out);
