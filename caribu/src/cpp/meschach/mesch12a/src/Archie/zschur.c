...
ZMAT	*A, *Q;
{
    ...
    Real	c;
    Mcomplex	det, discrim, lambda, lambda0, lambda1, s, sum, ztmp;
    Mcomplex	x, y;	/* for chasing algorithm */
    Mcomplex	**A_me;
	...
	while ( ! split )
	{
	    Mcomplex	a00, a01, a10, a11;
	    iter++;
	    
	    /* set up Wilkinson/Francis Mcomplex shift */
